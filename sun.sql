...
CREATE TABLE `mx_banner` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='banner管理';
...
INSERT INTO `mx_banner` VALUES ('3', '测试', '1', 'uploads/20170605/a97764c35656769ea77f06e18c56a5d5.jpg', '简介', '', '_blank', '1', '1', '1496676445', '1496676473');
...
-- ----------------------------
INSERT INTO `mx_banner_type` VALUES ('1', '首页轮播图', '1');
...
CREATE TABLE `mx_goods` (
  ...
  `orderid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='商品模块';
...
-- ----------------------------
INSERT INTO `mx_manager` VALUES ('1', 'admin', 'c3284d0f94606de1fd2af172aba15bf3', 'mashuxia', '18800000000', '6', '1', '1', '1485229169', '1495185990');
...
INSERT INTO `mx_manager` VALUES ('20', 'mashuxia', '14e1b600b1fd579f47433b88e8d85291', '马淑霞lucky', '18846938345', '6', '2', '1', '1486537383', '1495187223');

-- ----------------------------
-- Table structure for mx_mapprov
-- ----------------------------
DROP TABLE IF EXISTS `mx_mapprov`;
CREATE TABLE `mx_mapprov` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '地图标注主键',
  `name` varchar(255) NOT NULL COMMENT '姓名',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='地图标注';

-- ----------------------------
-- Records of mx_mapprov
-- ----------------------------
...
CREATE TABLE `mx_solution` (
  ...
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='轮播图管理';

-- ----------------------------
-- Records of mx_solution
-- ----------------------------
INSERT INTO `mx_solution` VALUES ('7', '23423', 'uploads/20170605/af119703f0170bfa316005fbbe50bf7a.jpg', '23', '1', '7', '1496676903', '1496846681');
...
CREATE TABLE `mx_test` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '测试2组主键',
  ...
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='测试2组';

-- ----------------------------
-- Records of mx_test
-- ----------------------------
INSERT INTO `mx_test` VALUES ('1', '的风格的风格', '0', '1', '1495185354', '1495185362');

-- ----------------------------
-- Table structure for mx_test_admin
-- ----------------------------
DROP TABLE IF EXISTS `mx_test_admin`;
CREATE TABLE `mx_test_admin` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '测试管理主键',
  `username` varchar(25) NOT NULL COMMENT '姓名',
  `picurl` varchar(255) NOT NULL COMMENT '头像',
  `sex` tinyint(1) NOT NULL COMMENT '性别',
  `intro` varchar(255) NOT NULL COMMENT '简介',
  `content` text NOT NULL COMMENT '编辑器',
  `birthday` int(10) NOT NULL COMMENT '生日',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='测试管理';

-- ----------------------------
-- Records of mx_test_admin
-- ----------------------------
INSERT INTO `mx_test_admin` VALUES ('1', '马淑霞', 'uploads/20170519/f5ef6aa413424678df70ad585a127101.jpg', '2', '个风格的风格的覆盖', '', '2017', '1495185254', '1495185254');
...
CREATE TABLE `mx_user` (
  ...
  `prov` char(6) DEFAULT '0' COMMENT '省',
  `city` char(6) DEFAULT '0' COMMENT '市',
  `area` char(6) DEFAULT '0' COMMENT '区',
  `address` varchar(50) DEFAULT '' COMMENT '详细地址',
  `create_time` int(10) unsigned DEFAULT '0' COMMENT '创建时间',
  `update_time` int(10) unsigned DEFAULT '0' COMMENT '更新时间',
  `status` tinyint(1) DEFAULT '1' COMMENT '状态，1-正常 | 0-禁用',
  `sd` varchar(255) DEFAULT '' COMMENT 'SD号',
  `lon` varchar(255) DEFAULT '',
  `lat` varchar(255) DEFAULT '' COMMENT '纬度',
  `idcard` varchar(255) DEFAULT '' COMMENT '身份证号',
  `prov_cn` varchar(50) DEFAULT '',
  `city_cn` varchar(50) DEFAULT '',
  `area_cn` varchar(50) DEFAULT '',
  PRIMARY KEY (`id`)
...
-- Records of mx_user
-- ----------------------------
INSERT INTO `mx_user` VALUES ('1', '18846938242', '14e1b600b1fd579f47433b88e8d85291', '马淑霞了', '18846938242', '130000', '130200', '130201', '', '1492495142', '1495185834', '1', null, null, null, null, '', null, null);
...
-- ----------------------------
INSERT INTO `mx_webconfig` VALUES ('1', 'web_name', '网站名称', '2', 'text', '管理后台', '1');
INSERT INTO `mx_webconfig` VALUES ('2', 'web_url', '网站地址', '2', 'text', 'http://www.longcai.com', '4');
INSERT INTO `mx_webconfig` VALUES ('3', 'web_author', '网站作者', '2', 'text', '李生伟', '2');
INSERT INTO `mx_webconfig` VALUES ('4', 'web_description', '网站描述', '2', 'textarea', '后台', '3');
...
INSERT INTO `mx_webconfig` VALUES ('14', 'web_qrcode', '二维码', '2', 'image', 'uploads/20170605/9803962a945e9741dab4487cc586b9f7.png', '7');
