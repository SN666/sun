...
use think\Request;
use think\Url;
use app\console\model\TestAdmin as ThisModel;

class TestAdmin extends Base
{
    /**
	...
	public function create()
	{
		if (Request::instance()->isPOST())
		{
			...
			if (true === $result) {
                $this->success('新建成功', 'console/TestAdmin/index');
            } else {
                $this->error($result);
            }
		}
	...
	public function update($id)
	{
		if (Request::instance()->isPOST())
		{
			...
			if (true === $result) {
                $this->success('更新成功', 'console/TestAdmin/index');
            } else {
                $this->error($result);
            }
		}
	...
	public function delete(){
		if (Request::instance()->isPOST())
		{
			...
			if($delmodel){
			    $this->success('删除成功', 'console/TestAdmin/index');
			}
			else{
