...
class User extends Base
{
	...
	public function update($id)
	{
		...
		$data = ThisModel::field('u.*,p.name as provname,c.name as cityname,a.name as areaname')
		->alias('u')
		->join('cn_prov p','u.prov = p.code')
		->join('cn_city c','u.city = c.code')
		->join('cn_area a','u.area = a.code')
		->find($id);
