...
use think\Request;
use think\Url;
use app\console\model\Qa as ThisModel;
...
class Qa extends Base
{
    ...
    public function create()
    {
        if (Request::instance()->isPOST())
        {
            ...
            if (true === $result) {
                $this->success('新建成功', 'console/Qa/index');
            } else {
                $this->error($result);
            }
        }
    ...
    public function update($id)
    {
        if (Request::instance()->isPOST())
        {
            ...
            if (true === $result) {
                $this->success('更新成功', 'console/Qa/index');
            } else {
                $this->error($result);
            }
        }

        $data = ThisModel::field('id,title')
    ...
    public function delete(){
        if (Request::instance()->isPOST())
        {
            ...
            if($delmodel){
                $this->success('删除成功', 'console/Qa/index');
            }
            else{
